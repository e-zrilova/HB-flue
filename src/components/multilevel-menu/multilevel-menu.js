...
const asideList = document.querySelector('.js-multilevel-menu__list');
const btnAsideExit = document.querySelector('.js-multilevel-menu__mobile-exit ')
const btnAsideMobile = document.querySelector('.js-multilevel-menu-mobile-btn')
if (asideList) {
  const asideItem_1 = document.querySelectorAll('.multilevel-menu__item-1');
  ...
  const asideItem_2 = document.querySelectorAll('.multilevel-menu__item-2');
  if (asideItem_2) {
  ...
  const asideItem_3 = document.querySelectorAll('.multilevel-menu__item-3');
  if (asideItem_3) {
